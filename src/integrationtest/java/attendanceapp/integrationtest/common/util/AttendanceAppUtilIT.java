...
public class AttendanceAppUtilIT {
	...
	public static Properties readDatabaseProperties(String fileName) {
		...
		File file = new File(
				AttendanceAppUnitTestUtil
						.resourceToString(DATABASEPROPERTIESFILE));
	...
	public static void mysqlScriptRunner(String sqlQueryFileName)
		...
		Connection con = (Connection) DriverManager.getConnection(
				prop.getProperty(JDBCURL), prop.getProperty(JDBCUSERNAME),
				prop.getProperty(JDBCPASSWORD));

		File file = new File(
				AttendanceAppUnitTestUtil.resourceToString(sqlQueryFileName));
		InputStream inputStream = null;
		...
		try {
			...
			System.err.println("Failed to Execute" + sqlQueryFileName
