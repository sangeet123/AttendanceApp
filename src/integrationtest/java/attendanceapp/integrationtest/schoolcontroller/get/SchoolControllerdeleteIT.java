...
public class SchoolControllerdeleteIT extends TestConfigurerIT {
	...
	public void delete_school_with_valid_id_1_that_exist() throws Exception {
		...
		getMockMvc()
				.perform(
						delete(SchoolControllerConstantsIT.DELETESCHOOL,
								validSchoolId))
				...
				.andExpect(
						content()
								.string("{\"statusCode\":1,\"message\":[\"School has been deleted successfully.\"]}"));
	}
	...
	@Test
	public void delete_school_with_valid_id_15_that_does_not_exist()
			throws Exception {
