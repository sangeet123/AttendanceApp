...
public final class SchoolRestControllerConstants {
	...
	public static final String DELETE_SCHOOL_LIST = "/deleteselected";
	...
	public static final String SELECTED_SCHOOL_DELETE_SUCCESS = "Selected schools has been deleted successfully.";
